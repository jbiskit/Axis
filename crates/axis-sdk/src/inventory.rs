...
const GRAPH_APP_TYPES: &[GraphAppType] = &[
    ...
    GraphAppType { odata_type: "microsoft.graph.officeSuiteApp", platform: "windows", kind: "store", label: "Microsoft 365", exclude_win32_catalog: false },
    GraphAppType { odata_type: "microsoft.graph.windowsMicrosoftEdgeApp", platform: "windows", kind: "store", label: "Edge", exclude_win32_catalog: false },
    GraphAppType { odata_type: "microsoft.graph.windowsWebApp", platform: "windows", kind: "store", label: "Web link", exclude_win32_catalog: false },
