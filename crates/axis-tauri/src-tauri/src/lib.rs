...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            fetch_glance,
            refresh_glance,
            commands::list_intune_audit_events_cmd,
            ...
            commands::fetch_policy_sets_cmd,
            ...
            commands::fetch_pack_artifact_text_cmd,
            commands::import_pack_json_document_cmd,
            commands::import_pack_script_text_cmd,
            commands::pick_local_pack_folder_cmd,
            commands::open_pack_workspace_cmd,
            commands::open_pack_workspace_from_source_cmd,
            commands::write_pack_kit_cmd,
            commands::create_pack_kit_cmd,
            commands::create_local_pack_cmd,
            commands::plan_pack_kit_apply_cmd,
            commands::apply_pack_kit_cmd,
            ...
            commands::generate_environment_report_cmd,
            commands::export_tenant_pack_cmd,
            commands::export_selected_objects_cmd,
            ...
            commands::update_enrollment_platform_restrictions_cmd,
            commands::update_enrollment_limit_cmd,
            ...
            commands::update_autopilot_device_group_tag_cmd,
            commands::fetch_windows_autopilot_settings_cmd,
            commands::sync_windows_autopilot_devices_cmd,
